...
| 優先度 | Phase | 計画ファイル | 状態 |
|---|---|---|---|
| 1 | リアーキ全体 | [rearchitecture-plan.md](docs/plans/rearchitecture-plan.md) | 未着手（親計画） |
| 2 | リアーキ Phase 1 | [rearch-phase1.md](docs/plans/rearch-phase1.md) | 未着手 |
...
| Phase | 計画ファイル | 状態 |
|---|---|---|
| 単発 | [app-window-grouping.md](docs/plans/app-window-grouping.md) | 完了（2026-07-05。リリース時に version 2.1.1+ 必須、D&D 実機確認残） |
