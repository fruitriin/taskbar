...
const sampleWindowData = [
  {
    ...
    kCGWindowNumber: 14444,
    kCGWindowBounds: { X: 0, Height: 24, Y: 0, Width: 3440 },
    kCGWindowName: '',
    kCGWindowStoreType: 1,
    kCGWindowLayer: 0,
    kCGWindowOwnerPID: 56463,
  ...
  },
  {
    ...
    kCGWindowOwnerName: 'ターミナル',
    kCGWindowAlpha: 1,
    kCGWindowBounds: { X: 567, Height: 262, Y: 848, Width: 260 },
    kCGWindowStoreType: 1,
    kCGWindowNumber: 10888,
    kCGWindowOwnerPID: 56463,
    kCGWindowMemoryUsage: 2288,
    kCGWindowSharingState: 1,
  ...
  },
  {
    ...
    kCGWindowSharingState: 1,
    kCGWindowStoreType: 1,
    kCGWindowBounds: { X: 2268, Height: 77, Y: 1094, Width: 84 },
    kCGWindowMemoryUsage: 2288,
    kCGWindowOwnerPID: 56463,
    kCGWindowNumber: 10767,
    kCGWindowAlpha: 1
  },
  {
    kCGWindowSharingState: 1,
    kCGWindowOwnerName: 'ターミナル',
    kCGWindowNumber: 14443,
    kCGWindowBounds: { X: 0, Height: 24, Y: 0, Width: 3440 },
    kCGWindowName: '',
    kCGWindowStoreType: 1,
    kCGWindowLayer: 0,
