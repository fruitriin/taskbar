...
| 2-D | mise 廃止の実施 | — | **完了（2026-07-07）**。全15タスクを package.json scripts へ移植（bun run <task>）、.node-version 新設、settings.json の許可を非破壊タスクの明示列挙に更新。bun のバージョンピンは意図的に無し。残: オーナーによる bun run dev の実機確認 |
